...
// props: image
export function FloatImageCol(props) {
    return (
        props.mobile ? 
        <motion.div 
        ...
        : <Col span={props.mobile ? 'none' : 12}>
            ...
            <motion.div 
                ...
                <Image 
                style={{
                    marginTop: props.mobile ? '-20%' : '-25%',
                    objectFit: 'cover',
                }}
                height={props.mobile? '100vh': 600} preview={false} src={props.image}> 
                </Image>
                </Row>
            </motion.div>
            </Row>
...
// props title, text
export function FloatTextCol(props) {
    return (
        <Col span={props.mobile ? 'none': 12}>
            <motion.div 
                    initial={{y: 50, opacity: 0}} 
                ...
                {
                    props.additionalTextComponents && <Row justify='center' style={{'padding': '20px 50px'}}>
                    {props.additionalTextComponents}
                </Row>
                }
            {
            props.appleStoreLink && <Row style={{
                // justify:'center',
                display:'flex',
                flexDirection:'row',
                alignItems: 'center',
            ...
            <a href={props.appleStoreLink} target='_blank' rel="noopener noreferrer">
            {props.appLogo && 
            <Image 
            height={50} 
            width={50}
            style={{borderRadius: '5px'}} preview={false} src={props.appLogo}></Image>}
                <Image 
                // height={50} 
                preview={false} src={props.appleStoreBadge}>
...
function SectionItemMobile(props) {
    return (
        <Col justify='center' align='middle' style={{'backgroundColor': props.backgroundColor, 'height': '100vh'}}>
            <Row justify='center' align='center' >
                {/* <FloatImageCol image={props.sectionItem.image} /> */}
            {props.mobileImage}
            </Row>
            <Row justify='center' align='center' >
                <FloatTextCol {...props.sectionItem} /> 
            </Row>
        </Col>
    )
}
...
function SectionItemImageOnTheLeft(props) {
    return (
        <Row justify='center' align='middle' style={{'backgroundColor': props.backgroundColor, 'height': '700px', 'padding': '50px'}}>
            <Row justify='center' align='center' style={{'maxWidth': '2000px'}}>
                <FloatImageCol image={props.sectionItem.image} />
                <FloatTextCol {...props.sectionItem} /> 
                {/* <FloatTextCol additiontitle={props.sectionItem.title} text={props.sectionItem.text} appleStoreBadge={props.sectionItem.appleStoreBadge} appleStoreLink={props.sectionItem.appleStoreLink} /> */}
            </Row>
        </Row>
    )
}
...
// props: sectionItem, backgroundColor
export function SectionItemImageOnTheRight(props) {
    return (
        <Row justify='center' align='middle' style={{'backgroundColor': props.backgroundColor, 'height': '700px', 'padding': '100px'}}>
            <Row justify='center' align='center' style={{'maxWidth': '2000px'}}>
                <FloatTextCol {...props.sectionItem} />
                {/* <FloatTextCol title={props.sectionItem.title} text={props.sectionItem.text} appleStoreBadge={props.sectionItem.appleStoreBadge} appleStoreLink={props.sectionItem.appleStoreLink}/> */}
                <FloatImageCol image={props.sectionItem.image} />
            </Row>
        </Row>
    )
    ...
    return (
        <>
        {
            props.sectionList.map((sectionItem, index) => {
                return (
                    mobile ? <SectionItemMobile sectionItem={sectionItem} /> : 
                    index % 2 === 0?
